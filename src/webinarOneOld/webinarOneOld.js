...
export default function WebinarOneOld(){
    ...
    function get(){
        console.log(id)
        fetch(server+"api/postOldWebinar",{
            method: 'post',
            headers: {
    ...
    function by(e){
        e.preventDefault()
        fetch(server+"api/byWebinarOld",{
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
            },
            body: JSON.stringify({
                pib,tel,city,email,name,promoCod,position,question,value,url,edrpo,hb,permission
            })
        }).then(response => {
    ...
    const [value, setValue] = React.useState('Medoc');
        ...
        <div className="main"  style={{backgroundColor:"#f3f5f9"}}>
            ...
            <div className="webinarHeader">
                <div className="contentWebinarRight">
                    ...
                    <button className="contactsSubmit" onClick={handleOpen}>Замовити відеозапис та матеріали</button>
                </div>
            ...
            <div className="textByWebinar">
                ...
                <br/>
                <button className="bigButton" onClick={handleOpen}>Замовити відеозапис та матеріали</button>
                <br/><br/>
                <div>
                    ...
                    <form id="form" style={cssModal.from} onSubmit={(e)=>{by(e)}}>
                        <Box sx={cssModal.content}>
                            ...
                            <Box sx={cssModal.contentLeftRight}>
                                ...
                                {
                                    cityForm?<Input sx={cssModal.input} placeholder="Адреса пошти, куди надсилати документи" onChange={(e)=>{setCity(e.target.value)}}/>:<></>
                                }
                                {
                        ...
                        <FormGroup>
                            <FormLabel id="demo-radio-buttons-group-label">Куди надсилати документи по вебінару?</FormLabel>
                            <RadioGroup
                                ...
                                defaultValue="Medoc"
                            >
                                <FormControlLabel value="Вчасно ЕДО" control={<Radio />} label="Вчасно ЕДО" />
                                <FormControlLabel value="Medoc" control={<Radio />} label="Medoc" />
                                <FormControlLabel value="Укр пошта, Нова пошта, ел пошта" control={<Radio />} label="Укр пошта, Нова пошта, ел пошта" />
                            </RadioGroup>
                        ...
                        <button type="submit" className="carouselListLeftButton"  >Замовити відео запис</button>
                    </form>
                </Box>
            </Modal>
        </div>
