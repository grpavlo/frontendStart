...
export default function  Partner(){
    ...
    function submit(){
        if(submitAndUpdate === "submit"){
            if(value !== null && url !== ""){
                ...
                fetch(server+'api/uploadPartner', {
                    method: 'POST',
                    body: formData
                })
            ...
            .then(data => {
                ...
                setRows(data.map((row,index) => (
                    <TableRow key={row.id}>
                        ...
                        <TableCell><CardImg src={process.env.PUBLIC_URL+"/Partner/"+row.namephoto}></CardImg></TableCell>
    ...
    function deleteF(){
        fetch(server+"api/deletePartner",{
            headers: {
                'Content-Type': 'application/json',
            },
            method: 'POST',
    ...
    function editDB(){
        ...
        if(url !== ""){
            ...
            fetch(server+"api/updatePartner",{
                headers: {
                    'Content-Type': 'application/json',
                },
                method: 'POST',
